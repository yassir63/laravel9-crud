        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="filiere" value="{{ $student->filiere }}" class="form-control"
                           placeholder="student filiere">
                    @error('filiere')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div>
                ...
                <a class="btn btn-danger" href="{{ route('students.index') }}" enctype="multipart/form-data"> Back</a>
            </div>
